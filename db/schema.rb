...
ActiveRecord::Schema.define(version: 20170228093357) do
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.index ["id", "subscribers"], name: "index_questions_on_id_and_subscribers", using: :btree
    t.index ["subscribers"], name: "index_questions_on_subscribers", using: :gin
